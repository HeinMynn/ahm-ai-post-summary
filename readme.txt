...
= 1.3.8 =
* Fixed: Key Takeaways now returns 3–5 distinct bullets instead of one chopped line
* Fixed: Gutenberg no longer overwrites a regenerated summary on autosave
...
* Changed: Summary title is no longer a heading, so theme h4 rules cannot change its size or weight

= 1.3.2 =
* Changed: Five summary themes inherit post type and site accent; no hardcoded hex, gradients, or Georgia
* Changed: Admin theme picker previews use the same frontend box classes and the real disclaimer
